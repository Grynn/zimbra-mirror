...
my @zmodules =qw(Archive::Tar Archive::Zip Array::Compare BerkeleyDB Bit::Vector Cache::FastMmap Carp::Clan Class::Inspector Compress::Raw::Bzip2 Compress::Raw::Zlib Compress::Zlib Config::IniFiles Config::Properties Convert::ASN1 Convert::BinHex Convert::TNEF Convert::UUlib Crypt::OpenSSL::Random Crypt::OpenSSL::RSA Crypt::SaltedHash Crypt::SSLeay DB_File DBD::mysql DBD::SQLite DBI Data::UUID Date::Calc Date::Format Date::Manip Date::Parse Devel::Symdump Device::SerialPort Digest::HMAC Digest::HMAC_MD5 Digest::SHA Digest::SHA1 Error ExtUtils::Constant File::Grep File::Tail File::Temp Geography::Countries Getopt::Easy HTML::Parser HTML::Tagset HTTP::Parser HTTP::Request IO IO::Compress::Base IO::Compress::Gzip IO::File IO::Handle IO::Select IO::Socket IO::Socket::INET IO::Socket::INET6 IO::Socket::IP IO::Socket::SSL IO::Socket::UNIX IO::Stringy IO::Uncompress::Gunzip IO::Wrap IO::Zlib IP::Country List::Compare LWP::UserAgent MIME::Entity MIME::Lite MIME::Parser MIME::Words Mail::DKIM Mail::Mailer Mail::SpamAssassin Mail::SpamAssassin::ArchiveIterator Mail::SpamAssassin::Message Mail::SpamAssassin::PerMsgLearner Mail::SpamAssassin::Util::Progress Mail::SPF Net::DNS::Resolver Net::DNS::Resolver::Programmable Net::HTTP Net::IP Net::LDAP Net::LDAP::Entry Net::LDAP::LDIF Net::LDAPapi Net::SMTP Net::SSLeay Net::Server Net::Telnet NetAddr::IP Package::Constants Parallel::ForkManager Pod::Coverage Pod::Escapes Pod::Simple Proc::ProcessTable Scalar::Util SOAP::Lite SOAP::Transport::HTTP Socket Socket6 Storable Sub::Uplevel Swatch::Actions Swatch::Throttle Task::Weaken Test::Deep Test::Exception Test::NoWarnings Test::Pod Test::Pod::Coverage Test::Simple Test::Tester Test::Warn Time::HiRes Tree::DAG_Node Unix::Syslog URI version XML::Parser XML::SAX::Base XML::SAX::Expat XML::Simple ZMQ::Constants ZMQ::LibZMQ3);
