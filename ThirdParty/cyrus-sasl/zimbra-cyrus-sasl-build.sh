...
LIBS="/opt/zimbra/libxml2/lib/libxml2.a" CFLAGS="-g -O2 -I/opt/zimbra/libxml2/include/libxml2" ./configure --enable-zimbra --prefix=/opt/zimbra/${src} \
...
LIBS="-lxml2" CFLAGS="-g -O2" ./configure --enable-zimbra --prefix=/opt/zimbra/${src} \
            --with-saslauthd=/opt/zimbra/${src}/state \
            --with-plugindir=/opt/zimbra/${src}/lib/sasl2 \
            --with-libxml2=/opt/zimbra/libxml2/bin/xml2-config \
			--with-dblib=no \
