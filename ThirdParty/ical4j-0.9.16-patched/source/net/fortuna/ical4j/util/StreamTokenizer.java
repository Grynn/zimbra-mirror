/*
 * Slightly modified version of java.io.StreamTokenizer.  The modification
 * is simply that escape sequences in quoted strings are not unescaped.
 * Quoted strings in iCalendar only occur in parameter values and they
 * don't support any escapes.  Backslash characters that occur in quoted
 * strings should be taken as is.
 */
