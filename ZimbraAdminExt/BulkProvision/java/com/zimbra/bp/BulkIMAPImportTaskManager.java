...
public class BulkIMAPImportTaskManager {
    /*
     * admin ID is a key to a queue (List) of import tasks. Each import task consists of an account ID and a Resource ID.
     */
    private static HashMap<String,Queue<HashMap<taskKeys,String>>> importQueues;
