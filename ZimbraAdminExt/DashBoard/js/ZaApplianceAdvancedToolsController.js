...
ZaApplianceAdvancedToolsController = function(appCtxt, container) {
	...
	this._helpURL = location.pathname + ZaUtil.HELP_URL + "appliance/zap_using_advanced_tools.htm?locid="+AjxEnv.DEFAULT_LOCALE;
...
function () {
	...
	this._toolbarOperations[ZaOperation.MIGRATION_WIZARD] = new ZaOperation(ZaOperation.MIGRATION_WIZARD, com_zimbra_dashboard.TBB_migration_wizard, com_zimbra_dashboard.TBB_migration_wizard_tt, "ApplianceMigration", "ApplianceMigration", new AjxListener(this, this.openMigrationWizard));
