...
void CSingleton::init()
{
	...
	m_LogFileHandle = CreateFile(L"C:\\Temp\\Migrationlog.log", dwFileFlags,FILE_SHARE_READ|FILE_SHARE_WRITE, NULL, OPEN_EXISTING, 0, NULL);
