...
namespace CssLib
{
	public class CSUnmanagedTestClass : IDisposable
	{
		...
		*/
        ...
        [DllImport("CppLib.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
		static private  extern void CallDoSomething(IntPtr pTestClassObject, string strValue,int type);
