...
namespace ZimbraMigrationConsole
{
    class Migration
    {
        public void test(string accountname)
        {
   ...
   //     }
        ...
        public void i_OnChanged1(object sender,
                                  MigrationObjectEventArgs e)
        {
            ...
            Console.WriteLine(String.Format(Message, i.Accountname,i.TotalNoContacts,i.TotalNoMails,i.TotalNoRules));
        }

        public void i_OnChanged12(object sender,
                                  MigrationObjectEventArgs e)
        {
            ...
            Console.WriteLine(String.Format(Message, i.FolderName, i.CurrentCountOFItems, i.TotalCountOFItems));
