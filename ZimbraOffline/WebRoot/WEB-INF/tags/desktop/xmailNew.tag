...
<c:choose>
	...
	<form name="xmailNew" action="${uri}" method="POST">
		...
		<table class="ZWizardForm" border=0>
			<tr>
				...
				<td>
					<input style='width:200px' class="ZField" type="text" id="dataSourceName" name="dataSourceName" value="${bean.dataSourceName}">
					<span id='service_hint' class='ZHint'>(e.g. My ISP)</span>
				</td>
			</tr>

			<tr>
				<td class="ZFieldLabel">Your full name:</td>
				...
				<td>
					<table cellspacing=0 cellpadding=0>
						<tr>
							...
							<td width=100%><input style='width:50px' class="ZField" disabled='true' type="text" id="port" name="port" value="${bean.port}">&nbsp;&nbsp;<a href="#" onclick="zd.enable('port');this.style.display='none'">Edit</a></td>
						</tr>
					</table>
				</td>
			</tr>
				...
				<td>
					<table cellspacing=0 cellpadding=0>
						<tr>
							...
							<td width=100%><input style='width:50px' class="ZField" disabled='true' type="text" id="smtpPort" name="smtpPort" value="${bean.smtpPort}">&nbsp;&nbsp;<a href="#" onclick="zd.enable('smtpPort');this.style.display='none'">Edit</a></td>
						</tr>
					</table>
				</td>
			</tr>
	...
	<table class="ZWizardButtonBar" width="100%">
		<tr>
			<td class="ZWizardButton"><button id='typeButton' class='DwtButton' onclick="OnPickType()">Use a Different Account Type</button></td>
			<td class="ZWizardButtonSpacer"><div></div></td>
			<td class="ZWizardButton" width="1%"><button id='cancelButton' class='DwtButton' onclick="OnCancel()">Cancel</button></td>
			<td class="ZWizardButton" width="1%"><button id='saveButton' class='DwtButton-focused' onclick="OnSubmit()">Save Settings</button></td>
		</tr>
	</table>
</div>
<br>
