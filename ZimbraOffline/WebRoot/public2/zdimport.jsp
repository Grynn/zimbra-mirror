...
<% } else if (act.equals("modify")) { %>
	Ajax.showPanel("changeService_i");
<% } else if (act.equals("smtp")) { %>
	Ajax.showPanel("smtp");
<% } else if (act.equals("delete") || act.equals("wipe")) { %>
	Ajax.showPanel("manageServices");
<% } %>
<% } else { %>
<% if (act == null) { %>
	Ajax.showPanel("manageServices");
<% } else if (act.equals("new")) { %>
	Ajax.showPanel("serviceCreated");
<% } else if (act.equals("modify")) { %>
	Ajax.showPanel("serviceModified");
<% } else if (act.equals("smtp")) { %>
	Ajax.showPanel("smtpSaved");
<% } else if (act.equals("delete") || act.equals("wipe")) { %>
	Ajax.showPanel("serviceDeleted");
<% } %>
<% } %>
}
...
<!-- NOTE: replace with file panel/manageServices.jsp --->
<div id="manageServices" class="ZWizardPage">
    ...
    <div class="ZWizardPageTitle"><%=service%> --&gt; <%=username%></div>
        ...
        <table class="ZWizardForm" cellpadding=5 style='margin-left:20px;'>
            <tr>
                <td valign=top>
                    <button onclick="Ajax.showPanel('changeService_<%=i%>')" style='width:140px'>
    ...
    <table class="ZWizardButtonBar">
        <tr>
            ...
            <td class="ZWizardButton">
                <button onclick="Ajax.showPanel('smtp')">Config Default SMTP</button>
            </td-->
            ...
            <td class="ZWizardButton">
                <button onclick="Ajax.showPanel('newService')">Add New Service</button>
            </td>
    </table>
</div>
...
<!-- NOTE: replace with file panel/serviceCreated.jsp --->
<div id="serviceCreated" class="ZWizardPage">
    ...
    <table class="ZWizardButtonBar">
        <tr>
            ...
            <td class="ZWizardButton">
                <button onclick="Ajax.showPanel('manageServices')">OK</button>
            </td>
    </table>
</div>
...
<!-- NOTE: replace with file panel/serviceModified.jsp --->
...
<!-- NOTE: replace with file panel/smtpSaved.jsp --->
...
<!-- NOTE: replace with file panel/serviceDeleted.jsp --->
...
<!-- NOTE: replace with file panel/changeService_i.jsp --->
...
<table class="ZWizardButtonBar">
    <tr>
        ...
        <td class="ZWizardButton">
            <button onclick="Ajax.showPanel('manageServices')">Back</button>
        </td>
        <td class="ZWizardButton">
...
<!-- NOTE: replace with file panel/newService.jsp --->
...
<!-- NOTE: replace with file panel/smtp.jsp --->
