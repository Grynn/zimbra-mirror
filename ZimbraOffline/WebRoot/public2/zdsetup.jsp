...
function showSetupPage() {
    window.location = "<%=LOCALHOST_RESOURCE_URL%>";
}
...
function OnModifySettings() {
    proxy.act.value = "modify";
    proxy.submit();
}

function InitScreen() {
<% if (act != null && act.equals("modify")) { %>
    Ajax.showPanel('proxy');
<%--<% } else if (accounts.size() + dataSources.size() == 0) { %>--%>
	//Ajax.showPanel('welcome');
<% } else { %>
...
<!-- NOTE: replace with file panel/welcome.jsp --->
<div id="welcome" class='ZWizardPage' style='display:block'>
    ...
    <p>In order to synchronize your email, we must store the login
        ...
        to access this computer. <a href="javascript:Ajax.togglePlatformNotice('secureSetup')">How do I do this?</a>
    </p>
    ...
    <table class="ZWizardButtonBar">
        <tr>
            ...
            <td class="ZWizardButton">
                <button onclick="Ajax.showPanel('console')()">Next</button>
            </td>
    </table>
</div>


<!-- NOTE: replace with file panel/console.jsp --->
<div id="console" class="ZWizardPage">
    ...
    <table class="ZWizardForm" cellpadding=5 style='margin-left:20px;'>
        <tr>
            <td valign=top>
                <button onclick="showAccountsPage()" style='width:100%'>
        ...
        <tr>
            <td valign=top>
                <button onclick="showServicesPage()" style='width:100%'>
        ...
        <tr>
            <td valign=top>
                <button onclick="Ajax.showPanel('smtp')" style='width:100%' disabled>
...
<!-- NOTE: replace with file panel/proxy.jsp --->
...
<form name="proxy" action="/zimbra/" method="POST">
...
<table class="ZWizardButtonBar">
    <tr>
        ...
        <td class="ZWizardButton">
            <button onclick="Ajax.showPanel('console')()">Back</button>
        </td>
        <td class="ZWizardButton">
...
<!-- NOTE: replace with file panel/changesSaved.jsp --->
