...
public class DistributionListItem extends ContactItem implements IItem {
	...
	public static final String IMAGE_CLASS   = "ImgGALContact";
	 ...
	 */
	public DistributionListItem(String groupName) {
	...
	public static DistributionListItem generateContactItem(GenerateItemType type) throws HarnessException {
	
		DistributionListItem group =  null;
		if ( type.equals(GenerateItemType.Default) || type.equals(GenerateItemType.Basic) ) {
			...
			group = new DistributionListItem(groupName);
	...
	public static DistributionListItem createUsingSOAP(AbsApplication app,  String ... tagIdArray ) throws HarnessException {
	        ...
	        // Create a contact group 
			DistributionListItem group = DistributionListItem.generateContactItem(GenerateItemType.Basic);
