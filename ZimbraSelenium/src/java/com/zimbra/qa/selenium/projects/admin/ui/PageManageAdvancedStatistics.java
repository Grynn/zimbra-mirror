 ...
 *
 */
public class PageManageAdvancedStatistics extends AbsTab {
	...
	public static class Locators {
		...
		public static final String ADVANCED_STATISTICS="Advanced Statistics";
	}
	
	public PageManageAdvancedStatistics(AbsApplication application) {
		super(application);
	}
