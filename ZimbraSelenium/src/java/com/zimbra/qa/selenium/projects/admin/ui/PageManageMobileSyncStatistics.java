 ...
 *
 */
public class PageManageMobileSyncStatistics extends AbsTab {
	...
	public static class Locators {
		...
		public static final String MOBILESYNC_STATISTICS="MobileSync Statistics";
	}
	
	public PageManageMobileSyncStatistics(AbsApplication application) {
		super(application);
	}
