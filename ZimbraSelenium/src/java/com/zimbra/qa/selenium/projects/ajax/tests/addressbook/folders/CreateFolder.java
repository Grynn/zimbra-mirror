...
public class CreateFolder extends AjaxCommonTest {
	...
	@Test(description = "Create a new folder using context menu from root folder", groups = { "skip" })
	...
	@Test(description = "Create a new folder using   New -> New Addressbook", groups = { "skip" })
	public void ClickMenuNewNewAddressbook() throws HarnessException {

		// using the context menu + New Folder
		DialogCreateFolder createFolderDialog = (DialogCreateFolder) app.zPageAddressbook.zToolbarPressPulldown(Button.B_NEW, Button.O_NEW_FOLDER);
