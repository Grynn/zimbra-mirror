...
public class OpenLinkToMessage extends AjaxCommonTest {
	...
	@Bugs(	ids = "56802" )
	@Test(description = "Open link to the message - verify close button exists", groups = { "functional" })
	public void OpenLink_01() throws HarnessException {
		...
		app.zPageBriefcase.zWaitForElementPresent(PageMail.Locators.zCloseIconBtn_messageWindow);
		
		app.zPageBriefcase.zClick(PageMail.Locators.zCloseIconBtn_messageWindow);
		
		ZAssert.assertTrue(app.zPageBriefcase.sIsElementPresent(Locators.zTVRows),"Verify List View Rows are displayed after message pane is closed");
	}
