...
public class MultipleTags extends AjaxCommonTest {

	public MultipleTags() {
		logger.info("New "+ MultipleTags.class.getCanonicalName());
	...
	@Test(description = "Apply multiple tags to appointment using toolbar button in day view and remove all tags in day view",
			groups = { "functional" })
	public void MultipleTags_01() throws HarnessException {
