...
public class Bug_75277 extends AjaxCommonTest {

	@SuppressWarnings("serial")
	public Bug_75277() {
		logger.info("New "+ Bug_75277.class.getCanonicalName());
	 ...
	 * 10.Press Esc shortcut key using keyborad shortcut
	 * 
	 * Expected:Pressing Esc,task should get closed
	 * 
	 */
	@Bugs(	ids = "75277")
