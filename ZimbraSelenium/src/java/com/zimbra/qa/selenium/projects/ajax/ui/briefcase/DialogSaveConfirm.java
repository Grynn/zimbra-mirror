...
/**
 * A <code>DialogSaveConfirm</code> object represents a "Warning" dialog, such as "Message has been autosaved. Do you want to keep it", etc.
 * <p>
 * During construction, the div ID attribute must be specified, such as "YesNoCancel".
 */
public class DialogSaveConfirm extends AbsDialog {

	public static class DialogWarningID {
		
		public static DialogWarningID KeepAutosavedMessage = new DialogWarningID("YesNoCancel");
	...
	public DialogSaveConfirm(DialogWarningID dialogId, AbsApplication application) {
		super(application);
	...
	public AbsPage zClickButton(Button button) throws HarnessException {
		...
		String buttonsTableLocator = "css=div[id^='"+ MyDivId +"_button']";
		...
		if ( button == Button.B_YES ) {
			...
			locator = buttonsTableLocator + " td[id^='" + MyDivId + "']:contains(No)";
