...
public class FileBriefcaseOpen extends AbsDisplay {
	...
	public FileBriefcaseOpen(AbsApplication application) {
		super(application);
		logger.info("new " + DocumentBriefcaseOpen.class.getCanonicalName());
	}
	
	public FileBriefcaseOpen(AbsApplication application, IItem item) {
		super(application);
