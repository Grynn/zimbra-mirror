...
/**
 * The <code>FormMailSend<code> object defines a message with link or attachment view
 * in the Zimbra Ajax client.
 *   
 */
public class FormMailSend extends AbsForm {
	
	/**
	 * Defines Selenium locators for various objects in {@link FormMailSend}
	 */
	...
	public static class Field {
		...
		public static final Field Attachment = new Field("Attachment");
	...
	/**
	 * constuctor FormMailSend
	 * 
	 * @param application
	 */
	public FormMailSend(AbsApplication application) {
		super(application);
		
		logger.info("new " + FormMailSend.class.getCanonicalName());
	...
	public AbsPage zToolbarPressButton(Button button) throws HarnessException {
		...
		if ( button == Button.B_SEND ) {
			...
			page = new DialogSaveConfirm(DialogSaveConfirm.DialogWarningID.KeepAutosavedMessage, this.MyApplication);
