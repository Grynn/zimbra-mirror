...
public class ApptScheduleView extends ApptView {
	
	protected ApptScheduleView(AbsApplication application) {
		super(application);
		
		logger.info("new " + ApptScheduleView.class.getCanonicalName());
	}
