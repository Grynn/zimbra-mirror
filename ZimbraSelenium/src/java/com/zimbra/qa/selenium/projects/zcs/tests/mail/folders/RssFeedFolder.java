package com.zimbra.qa.selenium.projects.zcs.tests.mail.folders;
...
public class RssFeedFolder extends CommonTest {
	protected int i = 0;
	...
	public void verifyRssFeedUI() throws Exception {
		...
		checkForSkipException(
				...
				"na",
				"na",
				"zExistsDontWait method directly throws exception for zDialog (expected - should return string value if dialog not present)");
