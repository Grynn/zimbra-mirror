package com.zimbra.qa.selenium.projects.zcs.tests.preferences.addressbook;
...
public class ABPreferences extends CommonTest {
	...
	public void importContact(String csvFile, String englishContact)
		...
		File f = new File(ZimbraSeleniumProperties.getBaseDirectory() + "/src/java/projects/zcs/data/" + csvFile);
