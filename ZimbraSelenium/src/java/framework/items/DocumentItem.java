...
public class DocumentItem extends ZimbraItem implements IItem {
	...
	public void createUsingSOAP(ZimbraAccount account) throws HarnessException {
		e = account.soapSend(				
		       ...
		       "<doc name='" + docName + "' l='16' ct='application/x-zimbra-doc'>" +
		       "<content>&lt;html>&lt;body>" + docText + "&lt;/body>&lt;/html></content>" +
	...
	public void importFromSOAP(Element response) throws HarnessException {		
		try {
			...
			Element getDocumentResponse = ZimbraAccount.SoapClient.selectNode(response, "//mail:SaveDocumentResponse | //mail:SearchResponse");
	...
	public void importFromSOAP(ZimbraAccount account, String query) throws HarnessException {
		try {	
			...
			/*
			account.soapSend(
					"<GetDocumentRequest xmlns='urn:zimbraMail'>" +
					 	"<doc id='" + id + "'/>" +
	                "</GetDocumentRequest>");
			
			Element getDocumentResponse = account.soapSelectNode("//mail:GetDocumentResponse", 1);
			*/
	...
	public static void main(String[] args) throws Exception {
		...
		ZimbraAccount.AccountA().soapSend(
				"<SaveDocumentRequest requestId='0' xmlns='urn:zimbraMail'>" +
			       ...
			       "<content>&lt;html>&lt;body>" + "t1" + "&lt;/body>&lt;/html></content>" +
