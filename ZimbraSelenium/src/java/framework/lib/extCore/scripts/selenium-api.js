...
//create closure..
function selenium_createClosure(object, method) {
	var shim = function() {
...
Selenium.prototype.doSetStepTimeOut = function(time) {
	/**
	 * Sets the time-interval that selenium should wait b/w steps(applies for all steps in the tescase)
	 *
...
Selenium.prototype.doClickZButton = function(locator, param1, param2) {
	return Selenium.decorateFunctionWithTimeout(fnBind(this.browserbot.buttonCore, this.browserbot, locator, "click",  param1, param2), 30000);
};

Selenium.prototype.doWaitZButton = function(locator, param1, param2) {
	return Selenium.decorateFunctionWithTimeout(fnBind(this.browserbot.buttonCore, this.browserbot, locator, "wait",  param1, param2), 30000);
};

Selenium.prototype.doZButtonNotExists = function(locator, param1, param2) {
	return this.browserbot.buttonCore(locator, "notexists",  param1, param2);
};
Selenium.prototype.doZButtonExists = function(locator, param1, param2) {
	return this.browserbot.buttonCore(locator, "exists",  param1, param2);
};

Selenium.prototype.verifyZButtonEnabled = function(locator, param1, param2) {
	return Selenium.decorateFunctionWithTimeout(fnBind(this.browserbot.buttonCore, this.browserbot, locator, "enabled",  param1, param2), 30000);
};
Selenium.prototype.verifyZButtonDisabled = function(locator, param1, param2) {
	return Selenium.decorateFunctionWithTimeout(fnBind(this.browserbot.buttonCore, this.browserbot, locator, "disabled",  param1, param2), 30000);
};

//FOLDER FUNCTIONS......
Selenium.prototype.doClickZFolder = function(locator, param1, param2) {	
	return Selenium.decorateFunctionWithTimeout(fnBind(this.browserbot.folderCore, this.browserbot, locator, "click",  param1, param2), 30000);
};

Selenium.prototype.doRightClickZFolder = function(locator, param1, param2) {
	return Selenium.decorateFunctionWithTimeout(fnBind(this.browserbot.folderCore, this.browserbot, locator, "rtclick",  param1, param2), 30000);
};
Selenium.prototype.doExpandZFolder = function(locator, param1, param2) {
	return Selenium.decorateFunctionWithTimeout(fnBind(this.browserbot.folderExpandBtnCore, this.browserbot, locator, "click",  param1, param2), 30000);
};

Selenium.prototype.doZfolderExpandBtnExists = function(locator, param1, param2) {
	return this.browserbot.folderExpandBtnCore(locator, "exists",  param1, param2);

};
Selenium.prototype.doCollapseZFolder = function(locator, param1, param2) {
	return Selenium.decorateFunctionWithTimeout(fnBind(this.browserbot.folderCollapseBtnCore, this.browserbot, locator, "click",  param1, param2), 30000);
};
Selenium.prototype.doZFolderNotExists = function(locator, param1, param2) {
	return this.browserbot.folderCore(locator, "notexists",  param1, param2);
	
};
Selenium.prototype.doZFolderExists = function(locator, param1, param2) {
	return this.browserbot.folderCore(locator, "exists",  param1, param2);
};

Selenium.prototype.doWaitZFolder = function(locator, param1, param2) {
	return Selenium.decorateFunctionWithTimeout(fnBind(this.browserbot.folderCore, this.browserbot, locator, "wait",  param1, param2), 30000);
};

//MENU FUNCTIONS......
Selenium.prototype.doClickZMenuItem = function(locator, param1, param2) {
	return Selenium.decorateFunctionWithTimeout(fnBind(this.browserbot.menuItemCore, this.browserbot, locator, "click",  param1, param2), 30000);

};

Selenium.prototype.doZMenuItemNotExists = function(locator, param1, param2) {
	return this.browserbot.menuItemCore(locator, "notexists",  param1, param2);
	
};
Selenium.prototype.doZMenuItemExists = function(locator, param1, param2) {
	return this.browserbot.menuItemCore(locator, "exists",  param1, param2);	
};

Selenium.prototype.isZMenuItemEnabled = function(locator, param1, param2) {
	return this.browserbot.menuItemCore(locator, "enabled",  param1, param2);};
Selenium.prototype.isZMenuItemDisabled = function(locator, param1, param2) {
	return this.browserbot.menuItemCore(locator, "disabled",  param1, param2);
};



Selenium.prototype.doSayHello = function(helloString) {
...
Selenium.prototype.doClickZMail = function(mailSubject, verifyParam) {
	 ...
	 */
		...
		var element = this.browserbot.findZMail(mailSubject);
...
Selenium.prototype.doDblClickZMail = function(mailSubject, verifyParam) {
	 ...
	 */
		...
		var element = this.browserbot.findZMail(mailSubject);
		this.browserbot.doubleclickZElement(element);
//	}
...
Selenium.prototype.doZCheckboxSet = function(name) {
	 ...
	 * @param name Textarea field label(text near the field)
	 */
	 var element = this.browserbot.findZFormObject(name, "input", "checkbox", 1);
...
Selenium.prototype._setText = function(name, value, tag, type) {
		...
		//if(!number) number = 1;
		var element = this.browserbot.findZFormObject(name, tag, type);
...
Selenium.prototype.doEnterPerfLoginDetails = function() {
	/**
	 * Enter Perf login(perf@testdomain.com/test123 for testservers or user1/test123 for localhost) details(only for perf script)
	 *
	 */
	var user = "";
	var loc = this.browserbot.getCurrentWindow().document.location;
	if (loc.hostname == "rr.zimbra.com" || loc.hostname == "localhost")
		user = "user1";
	else
		user = "perf@testdomain.com";

	//this.doType("username", user);
	//this.doType("password", "test123");
	this.doZEditSet("Username:", user);
	this.doZPasswordEditSet("Password:", "test123");
...
Selenium.prototype.doSavePerfInfoToDB = function() {
	/**
	 * Saves Browser Rendering Time values into DB
	 *
	 */
	ZM_DB_OBJ.postPerfInfo();
};

Selenium.prototype.doPrintPerfInfoInCSV = function() {
	/**
	 * Prints perf info in csv format
	 *
	 */
	LOG.perfinfo("totalDivs_CSV: " + this.browserbot.totalDivs_CSV);
	LOG.perfinfo("scannedDivs_CSV: " + this.browserbot.scannedDivs_CSV);
	LOG.perfinfo("totalElements_CSV: " + this.browserbot.totalElements_CSV);
	LOG.perfinfo("verifyingObjIds_CSV: " + this.browserbot.verifyingObjIds_CSV);
	LOG.perfinfo("timetaken_CSV: " + this.browserbot.timetaken_CSV);
	LOG.perfinfo("headers_CSV: " + this.browserbot.headers_CSV);
	LOG.perfinfo("weight_CSV: " + this.browserbot.weight_CSV);
	LOG.perfinfo("totalDivsCount: " + this.browserbot.totalDivsCount);
	LOG.perfinfo("TotalScannedDivsCount: " + this.browserbot._scannedDivsCount);
...
Selenium.prototype.doClickZIconButton = function(locator, verifyParam) {
	...
	var element = this.browserbot.findZIconButton(className);
	this.browserbot.clickZElement(element);
...
Selenium.prototype._addWaitDecorator = function(verifyParam) {
	...
	var perfindx = verifyParam.indexOf("verify_perf:=");
	if (perfindx != -1) {
		arry = verifyParam.split(";");
		for (var i = 0; i < arry.length; i++) {
			if (arry[i].indexOf("verify_perf:=") >= 0) {
				this.doLogPerfMessage(arry[i].replace("verify_perf:=", ""));
			} else {
				verifyParam = arry[i];
			}
		}
...
Selenium.prototype.doClickZTab = function(locator, verifyParam) {
	 ...
	 * @param verifyParam verify_text verify_btn verify_tab verify_dlg verify_view verify_menu verify_tbl verify_fldr
	 */
	var element = this.browserbot.findZTab(locator);
	this.browserbot.clickZElement(element);
...
Selenium.prototype.doGoToAppln = function(appln, verifyParam) {
	 ...
	 */
	var func;
	var element = this.browserbot.findZAppTab(appln);
	this.browserbot.clickZElement(element);
	...
	if (verifyParam.indexOf("verify_perf:=") >= 0)
		this.doLogPerfMessage(verifyParam.replace("verify_perf:=", ""));
...
Selenium.prototype._isCalLoaded = function() {
	 ...
	 *
	 */
	return this.browserbot.isCalLoaded();
};
...
Selenium.prototype._isABLoaded = function() {
	 ...
	 *
	 */
	return this.browserbot.isABLoaded();
};
Selenium.prototype._isTasksLoaded = function() {
	 ...
	 *
	 */
	return this.browserbot.isTasksLoaded();
};
Selenium.prototype._isDocLoaded = function() {
	 ...
	 *
	 */
	return this.browserbot.isDocLoaded();
};
Selenium.prototype._isPrefLoaded = function() {
	 ...
	 *
	 */
	return this.browserbot.isPrefLoaded();
};
Selenium.prototype._isMailLoaded = function() {
	 ...
	 *
	 */
	return this.browserbot.isMailLoaded();
};
...
Selenium.prototype._verifyViewHasNoChild = function() {
	 ...
	 *
	 */
	return this.browserbot.verifyViewHasNoChild();
};
...
Selenium.prototype._closeDlgIfExists = function(dlgNameCommaBtnName) {
	 ...
	 */
	return this.browserbot.closeDlgIfExists(dlgNameCommaBtnName);
};
...
Selenium.prototype._waitAndActOnElement = function(objType, locator, action, param1, param2) {
	 ...
	 *  @param dlgNameCommaBtnName  "dialog name,button name"
	 */
			return this.browserbot.waitAndActOnElement(objType, locator, action, param1, param2);
};
...
Selenium.prototype._verifyZDialog = function(text) {
	 ...
	 */
	return this.browserbot.verifyZDialog(text);
};
...
Selenium.prototype._verifyZview = function(viewName) {
	 ...
	 */
	return this.browserbot.verifyZview(viewName);
};
Selenium.prototype._verifyZMenuWithMenuItem = function(menuItemName) {
	 ...
	 */
	return this.browserbot.verifyZMenuWithMenuItem(menuItemName);
};
...
Selenium.prototype._verifyZTable = function(tableId) {
	 ...
	 */
	return this.browserbot.verifyZTable(tableId);
};
...
Selenium.prototype._verifyZFolder = function(folderName) {
	 ...
	 */
	return this.browserbot.verifyZFolder(folderName);
};
...
Selenium.prototype._verifyZDisplayed = function(locatorWithZIndx) {
	 ...
	 */
	return this.browserbot.verifyZDisplayed(locatorWithZIndx);
};
...
Selenium.prototype._verifyMsgBdyInHyb = function(text) {
	 ...
	 */
	return this.browserbot.verify_msgBdyInHyb(text);
};
...
Selenium.prototype._verifyZmsgBdyInConv = function(text) {
	 ...
	 *  @param text message text
	 */
	return this.browserbot.verify_msgBdyInConv(text);
};
...
Selenium.prototype._verifyZButton = function(text) {
	 ...
	 *  @param text btn-name
	 */
	return this.browserbot.verifyZButton(text);
};
Selenium.prototype._verifyZTab = function(text) {
	 ...
	 *  @param text tab-name
	 */
	return this.browserbot.verifyZTab(text);
};
...
Selenium.prototype._verifyZText = function(text) {
	 ...
	 */
	return this.browserbot.verifyZText(text);
};
...
Selenium.prototype.doDontFailOnTimeout = function(trueOrFalse) {
//	debugger;
	/**
	 * Tells the harness not to fail  when the object is not present and even after timeout.
	 * Cane be used for -ve testing.
	 * @param trueOrFalse "true" or "false"
	 */

	if (trueOrFalse == "true")
		this.browserbot.dontFailOnTimeout = true;
	else
		this.browserbot.dontFailOnTimeout = false;
}
...
Selenium.prototype.doResetDBAccess = function() {
	/**
	 * Empties any performance values thats stored
	 *
	 */
	ZM_DB_OBJ.reset();
}
Selenium.prototype.doSetBrowserAndZimbraVersion = function() {
	/**
	 * Assigns Browser and Zimbra version to an internal variable used by DB-lib(currently no api)
	 *
	 */
	var win = this.browserbot.getCurrentWindow();
	...
	var version = win.appCtxt.getSettings().getSetting("SERVER_VERSION").value;
	ZM_DB_OBJ.storeDBVal("version", version);
	ZM_DB_OBJ.storeDBVal("browser", browserName);

}
Selenium.prototype.doLogPerfMessage = function(msg) {
	/**
	 * Logs performance time corresponding for the current step
	 * @param msg step name
	 */
	if (msg.indexOf("TIME TAKEN:") == -1)
		ZM_DB_OBJ.setCurrentUIMsg(msg);
	else
		ZM_DB_OBJ.setCurrentUIMsg("");

	//open log window and set start logging perf info to true.
	if (LOG.getLogWindow() == null) {
		LOG.show();
		this.doWaitForPopUp(LOG.getLogWindow(), 5000);
	}
	this.browserbot.headerName = msg;//used by csv reporting
	if (msg != "") {
		LOG.perfStartLogging = true;
		LOG.setPerfLogLevelCount(3);
		LOG.perfinfo(msg);
		LOG.setPerfLogLevelCount(1);
	}
}
