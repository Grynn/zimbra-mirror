...
public class ZObject extends SelNGBase {
	...
	protected String ZObjectCore(String objNameOrId, String action, Boolean retryOnFalse)  throws HarnessException  {
	...
	protected String ZObjectCore(String objNameOrId, String action, Boolean retryOnFalse,
			String panel)  throws HarnessException  {
	...
	protected String ZObjectCore(String objNameOrId, String action, Boolean retryOnFalse,
		...
		return ClientSessionFactory.session().selenium().call(coreName, objNameOrId, action, retryOnFalse, panel, param1,
				param2, param3);
	}
