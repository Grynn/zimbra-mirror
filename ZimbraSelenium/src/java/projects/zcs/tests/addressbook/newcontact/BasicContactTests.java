...
public class BasicContactTests extends CommonTest {
	...
	public Object[][] createData(Method method) {
		...
		if (test.equals("createContactGroupAndVerify_Bug45316")
	 ...
	 */
	@Test(dataProvider = "ABDataProvider", groups = { "smoke", "full" }, retryAnalyzer = RetryFailedTests.class)
	public void createContactGroupAndVerify_Bug45316(String groupName) throws Exception {
		if (isExecutionARetry)
			handleRetry();
	...
	/**
	 * Test case:-Previously selected contact group details are shown when no results found in search
	 * @param groupName
	 * @throws Exception
	 * @author Girish
	 */
	@Test(dataProvider = "ABDataProvider", groups = { "smoke", "full" }, retryAnalyzer = RetryFailedTests.class)
	public void updateContactGroupPaneWhenNoResult_Bug44331(String groupName) throws Exception {
		if (isExecutionARetry)
			handleRetry();
