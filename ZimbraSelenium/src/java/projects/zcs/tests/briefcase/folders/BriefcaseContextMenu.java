 ...
 * 
 */
public class BriefcaseContextMenu extends CommonTest {
	//--------------------------------------------------------------------------
	...
	public Object[][] createData(Method method) {
		...
		if (test.equals("briefcaseContextMenu")) {
	...
	public void briefcaseContextMenu(String briefcaseName) throws Exception {
