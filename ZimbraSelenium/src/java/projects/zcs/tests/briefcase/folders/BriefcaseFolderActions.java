 ...
 * 
 */
public class BriefcaseFolderActions extends CommonTest {
	//--------------------------------------------------------------------------
	...
	public Object[][] createData(Method method) {
		...
		if (test.equals("briefcaseActions")) {
	...
	public void briefcaseActions(String briefcaseName) throws Exception {
