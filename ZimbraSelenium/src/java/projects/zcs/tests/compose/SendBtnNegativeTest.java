...
public class SendBtnNegativeTest extends CommonTest {
    ...
    /**
     * Enters different invalid email address types and checks if alert/warning dialog is thrown
     */
    ...
    /**
     * Opens compose-view in new window. Enters different invalid email address types and checks if alert/warning dialog is thrown
     * when we hit send-btn. 
     */
    @Test(dataProvider = "composeDataProvider", groups = { "smoke", "full" }, retryAnalyzer = RetryFailedTests.class)
