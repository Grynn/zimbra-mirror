...
public class DocumentApp extends AppPage {
	...
	public static final String zTagPageBtn_ListView = "id=zb__NBF__TAG_MENU_left_icon";
	public static final String zBrowseIconBtn = "id=zb__NBP__BROWSE_FOLDER_left_icon";
