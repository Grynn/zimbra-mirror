...
public class MailApp extends CommonTest {
	...
	public static final String zSearchMenuIconBtn = "css=[id$=SEARCH_left_icon]";
	public static final String zAdvancedSearchMenuIconBtn = "css=[id$=BROWSE_left_icon]";
	public static final String zNewEmailMenuIconBtn = "css=[id$=NEW_MESSAGE_left_icon]";
	public static final String zAddToContactsMenuIconBtn = "css=[id$=CONTACT_left_icon]";
	public static final String zMarkReadMenuIconBtn = "css=[id$=MARK_READ_left_icon]";
	public static final String zMarkReadMenuEnaDisaBtn = "css=[id$=MARK_READ]";
	public static final String zMarkUnReadMenuIconBtn = "css=[id$=MARK_UNREAD_left_icon]";
	public static final String zMarkUnReadMenuEnaDisaBtn = "css=[id$=MARK_UNREAD]";
	public static final String zReplyMenuIconBtn = "css=[id$=REPLY_left_icon]";
	public static final String zReplyMenuEnaDisaBtn = "css=[id$=REPLY]";
	public static final String zReplyAllMenuIconBtn = "css=[id$=REPLY_ALL_left_icon]";
	public static final String zReplyAllMenuEnaDisaBtn = "css=[id$=REPLY_ALL]";
	public static final String zForwardMenuIconBtn = "css=[id$=FORWARD_left_icon]";
	public static final String zForwardMenuEnaDisaBtn = "css=[id$=FORWARD]";
	public static final String zEditAsNewMenuIconBtn = "css=[id$=EDIT_left_icon]";
	public static final String zEditAsNewMenuEnaDisaBtn = "css=[id$=EDIT]";
	public static final String zTagMenuIconBtn = "css=[id$=TAG_MENU_left_icon]";
	public static final String zNewTagMenuIconBtn = "css=[id$=TAG_MENU|MENU|NEWTAG_title]";
	public static final String zRemoveTagMenuIconBtn = "css=[id$=TAG_MENU|MENU|REMOVETAG_title]";
	public static final String zDeleteMenuIconBtn = "css=[id$=DELETE_left_icon]";
	public static final String zMoveMenuIconBtn = "css=[id$=MOVE_left_icon]";
	public static final String zPrintMenuIconBtn = "css=[id$=PRINT_left_icon]";
	public static final String zPrintMenuEnaDisaBtn = "css=[id$=PRINT]";
	public static final String zJunkMenuIconBtn = "css=[id$=SPAM_left_icon]";
	public static final String zShowOriginalMenuIconBtn = "css=[id$=SHOW_ORIG_left_icon]";
	public static final String zShowOriginalMenuEnaDisaBtn = "css=[id$=SHOW_ORIG]";
	public static final String zNewFilterMenuIconBtn = "css=[id$=ADD_FILTER_RULE_left_icon]";
	public static final String zNewFilterMenuEnaDisaBtn = "css=[id$=ADD_FILTER_RULE]";
	public static final String zCreateApptMenuIconBtn = "css=[id$=CREATE_APPT_left_icon]";
	public static final String zCreateApptEnaDisaBtn = "css=[id$=CREATE_APPT]";
	public static final String zCreateTaskMenuEnaDisaBtn = "css=[id$=CREATE_TASK_left_icon]";
	public static final String zCreateTaskEnaDisaBtn = "css=[id$=CREATE_TASK]";
	...
	public static final String zShowOriginalDraftMenuIconBtn = "css=[id$=Dra__SHOW_ORIG_left_icon]";
