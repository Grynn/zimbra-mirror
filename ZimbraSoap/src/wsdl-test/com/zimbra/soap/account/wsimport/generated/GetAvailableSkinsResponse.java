 ...
 *       &lt;sequence>
 *         &lt;element name="skin" type="{urn:zimbraAccount}namedElement" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetAvailableSkinsResponse {
    ...
    protected List<NamedElement> skin;
     ...
     * 
     */
    public List<NamedElement> getSkin() {
        if (skin == null) {
            skin = new ArrayList<NamedElement>();
        }
        return this.skin;
    }
