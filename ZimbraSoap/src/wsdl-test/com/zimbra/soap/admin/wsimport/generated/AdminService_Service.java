 ...
 * 
 */
@WebServiceClient(name = "AdminService", targetNamespace = "urn:zimbraAdmin", wsdlLocation = "file:/p4/gelliot_mac/ZimbraSoap/build/classes/com/zimbra/soap/AdminService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "file:/p4/gelliot_mac/ZimbraSoap/build/classes/com/zimbra/soap/AdminService.wsdl");
        } catch (MalformedURLException e) {
            logger.warn("Failed to create URL for the wsdl Location: 'file:/p4/gelliot_mac/ZimbraSoap/build/classes/com/zimbra/soap/AdminService.wsdl', retrying as a local file");
