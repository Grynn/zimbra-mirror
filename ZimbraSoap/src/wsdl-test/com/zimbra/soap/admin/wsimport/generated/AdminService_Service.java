 ...
 * 
 */
@WebServiceClient(name = "AdminService", targetNamespace = "urn:zimbraAdmin", wsdlLocation = "file:/p4/gelliot_main/ZimbraSoap/build/classes/com/zimbra/soap/AdminService.wsdl")
public class AdminService_Service
    extends Service
{

    private final static URL ADMINSERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(com.zimbra.soap.admin.wsimport.generated.AdminService_Service.class.getName());
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "file:/p4/gelliot_main/ZimbraSoap/build/classes/com/zimbra/soap/AdminService.wsdl");
        } catch (MalformedURLException e) {
            logger.warn("Failed to create URL for the wsdl Location: 'file:/p4/gelliot_main/ZimbraSoap/build/classes/com/zimbra/soap/AdminService.wsdl', retrying as a local file");
