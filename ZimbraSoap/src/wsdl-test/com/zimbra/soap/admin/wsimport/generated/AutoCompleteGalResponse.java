...
public class AutoCompleteGalResponse {
    ...
    protected List<AutoCompleteGalContactInfo> cn;
    @XmlAttribute
     ...
     * {@link AutoCompleteGalContactInfo }
     * 
     * 
     */
    public List<AutoCompleteGalContactInfo> getCn() {
        if (cn == null) {
            cn = new ArrayList<AutoCompleteGalContactInfo>();
        }
        return this.cn;
    }
