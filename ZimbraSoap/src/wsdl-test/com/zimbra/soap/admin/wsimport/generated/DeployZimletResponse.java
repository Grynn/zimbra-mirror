...
public class DeployZimletResponse {
    ...
    protected List<ZimletDeploymentStatus> progress;
     ...
     * {@link ZimletDeploymentStatus }
     * 
     * 
     */
    public List<ZimletDeploymentStatus> getProgress() {
        if (progress == null) {
            progress = new ArrayList<ZimletDeploymentStatus>();
        }
