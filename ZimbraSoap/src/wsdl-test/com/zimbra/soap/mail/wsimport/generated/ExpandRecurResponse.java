...
public class ExpandRecurResponse {
    ...
    protected List<ExpandedRecurrenceInstance> inst;
     ...
     * {@link ExpandedRecurrenceInstance }
     * 
     * 
     */
    public List<ExpandedRecurrenceInstance> getInst() {
        if (inst == null) {
            inst = new ArrayList<ExpandedRecurrenceInstance>();
        }
        return this.inst;
    }
