...
public class SyncDeletedInfo {
    ...
    protected List<JAXBElement<IdsAttr>> folderOrSearchOrLink;
     ...
     * {@link JAXBElement }{@code <}{@link IdsAttr }{@code >}
     * {@link JAXBElement }{@code <}{@link IdsAttr }{@code >}
     * {@link JAXBElement }{@code <}{@link IdsAttr }{@code >}
     * {@link JAXBElement }{@code <}{@link IdsAttr }{@code >}
     * {@link JAXBElement }{@code <}{@link IdsAttr }{@code >}
     ...
     * 
     */
    public List<JAXBElement<IdsAttr>> getFolderOrSearchOrLink() {
        if (folderOrSearchOrLink == null) {
            folderOrSearchOrLink = new ArrayList<JAXBElement<IdsAttr>>();
        }
