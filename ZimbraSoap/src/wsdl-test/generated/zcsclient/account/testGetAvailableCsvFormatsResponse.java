...
/**
 * <p>Java class for getAvailableCsvFormatsResponse complex type.
 * 
...
public class testGetAvailableCsvFormatsResponse {

    protected List<testNamedElement> csv;
     ...
     * 
     */
    public List<testNamedElement> getCsv() {
        if (csv == null) {
            csv = new ArrayList<testNamedElement>();
        }
        return this.csv;
    }
