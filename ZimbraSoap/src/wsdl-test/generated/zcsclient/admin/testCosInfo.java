...
/**
 * <p>Java class for cosInfo complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="a" type="{urn:zimbraAdmin}cosInfoAttr" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "cosInfo", propOrder = {
    "a"
})
public class testCosInfo {

    protected List<testCosInfoAttr> a;
     ...
     * {@link testCosInfoAttr }
     * 
     * 
     */
    public List<testCosInfoAttr> getA() {
        if (a == null) {
            a = new ArrayList<testCosInfoAttr>();
        }
        return this.a;
    }
