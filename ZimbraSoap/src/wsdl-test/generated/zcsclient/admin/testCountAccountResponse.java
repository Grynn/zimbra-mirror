...
public class testCountAccountResponse {

    protected List<testCosCountInfo> cos;
     ...
     * {@link testCosCountInfo }
     * 
     * 
     */
    public List<testCosCountInfo> getCos() {
        if (cos == null) {
            cos = new ArrayList<testCosCountInfo>();
        }
        return this.cos;
    }
