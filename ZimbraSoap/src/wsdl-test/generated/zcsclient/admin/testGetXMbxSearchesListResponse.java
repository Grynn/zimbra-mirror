...
/**
 * <p>Java class for getXMbxSearchesListResponse complex type.
 * 
...
public class testGetXMbxSearchesListResponse {

    protected List<testSearchNode> searchtask;
     ...
     * 
     */
    public List<testSearchNode> getSearchtask() {
        if (searchtask == null) {
            searchtask = new ArrayList<testSearchNode>();
        }
