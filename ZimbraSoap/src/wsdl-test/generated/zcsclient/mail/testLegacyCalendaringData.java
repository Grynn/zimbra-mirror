...
/**
 * <p>Java class for legacyCalendaringData complex type.
 * 
...
@XmlSeeAlso({
    testLegacyTaskData.class,
    testLegacyAppointmentData.class
})
public class testLegacyCalendaringData
    extends testCommonCalendaringData
{
    ...
    protected String fr;
    protected List<testLegacyInstanceDataInfo> inst;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link testLegacyInstanceDataInfo }
     * 
     * 
     */
    public List<testLegacyInstanceDataInfo> getInst() {
        if (inst == null) {
            inst = new ArrayList<testLegacyInstanceDataInfo>();
        }
        return this.inst;
    }
