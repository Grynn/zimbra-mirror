...
/**
 * <p>Java class for mailDataSource complex type.
 * 
...
@XmlSeeAlso({
    testMailGalDataSource.class,
    testMailImapDataSource.class,
    testMailYabDataSource.class,
    testMailPop3DataSource.class,
    testMailCaldavDataSource.class,
    testMailUnknownDataSource.class,
    testMailCalDataSource.class,
    testMailRssDataSource.class
})
public abstract class testMailDataSource {
    ...
    protected testMdsConnectionType connectionType;
     ...
     * @return
     *     possible object is
     *     {@link testMdsConnectionType }
     *     
     */
    public testMdsConnectionType getConnectionType() {
     ...
     *     
     */
    public void setConnectionType(testMdsConnectionType value) {
