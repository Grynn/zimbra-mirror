...
public class testModifyFromNumRequest {

    protected testStorePrincipalSpec storeprincipal;
    protected testModifyFromNumSpec phone;
     ...
     * @return
     *     possible object is
     *     {@link testModifyFromNumSpec }
     *     
     */
    public testModifyFromNumSpec getPhone() {
        return phone;
    }
     ...
     *     
     */
    public void setPhone(testModifyFromNumSpec value) {
        this.phone = value;
    }
