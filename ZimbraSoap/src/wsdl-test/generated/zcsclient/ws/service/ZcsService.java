 ...
 * 
 */
@WebServiceClient(name = "zcsService", targetNamespace = "http://www.zimbra.com/wsdl/ZimbraService.wsdl", wsdlLocation = "file:/p4/tarka/main/ZimbraSoap/build/classes/com/zimbra/soap/ZimbraService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            logger.warn("Failed to create URL for the wsdl Location: 'file:/p4/tarka/main/ZimbraSoap/build/classes/com/zimbra/soap/ZimbraService.wsdl', retrying as a local file");
