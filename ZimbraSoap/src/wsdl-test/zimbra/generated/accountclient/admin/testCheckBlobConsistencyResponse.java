...
/**
 * <p>Java class for checkBlobConsistencyResponse complex type.
 * 
...
public class testCheckBlobConsistencyResponse {

    protected List<testMailboxBlobConsistency> mbox;
     ...
     * {@link testMailboxBlobConsistency }
     * 
     * 
     */
    public List<testMailboxBlobConsistency> getMbox() {
        if (mbox == null) {
            mbox = new ArrayList<testMailboxBlobConsistency>();
        }
        return this.mbox;
    }
