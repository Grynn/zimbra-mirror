...
import zimbra.generated.accountclient.zm.testContactAttr;
 ...
 *         &lt;element name="m" type="{urn:zimbraAdmin}contactGroupMember" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class testContactInfo {
    ...
    protected List<testAdminCustomMetadata> meta;
     ...
     * {@link testAdminCustomMetadata }
     * 
     * 
     */
    public List<testAdminCustomMetadata> getMeta() {
        if (meta == null) {
            meta = new ArrayList<testAdminCustomMetadata>();
        }
        return this.meta;
    }
