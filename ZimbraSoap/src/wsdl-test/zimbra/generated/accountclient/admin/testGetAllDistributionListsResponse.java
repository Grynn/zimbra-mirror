...
public class testGetAllDistributionListsResponse {

    protected List<testDistributionListInfo> dl;
     ...
     * 
     */
    public List<testDistributionListInfo> getDl() {
        if (dl == null) {
            dl = new ArrayList<testDistributionListInfo>();
        }
        return this.dl;
    }
