...
public class testGetAllFreeBusyProvidersResponse {

    protected List<testFreeBusyProviderInfo> provider;
     ...
     * {@link testFreeBusyProviderInfo }
     * 
     * 
     */
    public List<testFreeBusyProviderInfo> getProvider() {
        if (provider == null) {
            provider = new ArrayList<testFreeBusyProviderInfo>();
        }
