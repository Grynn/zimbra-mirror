 ...
 *       &lt;sequence>
 *         &lt;element name="dataSource" type="{urn:zimbraAdmin}dataSourceInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class testGetDataSourcesResponse {
    ...
    protected List<testDataSourceInfo> dataSource;
     ...
     * 
     */
    public List<testDataSourceInfo> getDataSource() {
        if (dataSource == null) {
            dataSource = new ArrayList<testDataSourceInfo>();
        }
