...
import zimbra.generated.accountclient.zm.testShareInfo;
...
public class testGetShareInfoResponse {

    protected List<testShareInfo> share;
     ...
     * 
     */
    public List<testShareInfo> getShare() {
        if (share == null) {
            share = new ArrayList<testShareInfo>();
        }
        return this.share;
    }
