...
public class testSignature {
    ...
    protected List<testSignatureContent> content;
     ...
     * {@link testSignatureContent }
     * 
     * 
     */
    public List<testSignatureContent> getContent() {
        if (content == null) {
            content = new ArrayList<testSignatureContent>();
        }
        return this.content;
    }
