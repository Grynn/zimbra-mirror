...
/**
 * <p>Java class for calendarItemInfo complex type.
 * 
...
@XmlSeeAlso({
    testTaskItemInfo.class
})
public class testCalendarItemInfo {

    protected List<testInvitation> inv;
    protected testCalendarItemInfo.Replies replies;
     ...
     * @return
     *     possible object is
     *     {@link testCalendarItemInfo.Replies }
     *     
     */
    public testCalendarItemInfo.Replies getReplies() {
        return replies;
    }
     ...
     *     
     */
    public void setReplies(testCalendarItemInfo.Replies value) {
        this.replies = value;
    }
