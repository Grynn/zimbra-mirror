...
function addBanner(sImage)
{
	...
	{
		var nBtn=gaButtons.length;
		gaButtons[nBtn]="<td NOWRAP align=\"center\" valign=\"middle\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"javascript:void(0);\" onclick=\"showBanner();return false;\"><img alt=\"À propos de WebHelp\"src=\""+sImage+"\" border=0 align=\"absmiddle\"></a></td>";
		gaTypes[nBtn]="banner";
	}
}
