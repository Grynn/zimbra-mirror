		 ...
		 "<div ", (params.showAbout ? " " : "class='center'"), ">",
                ...
                "<tr>",
	                ...
	                "<td style='text-align:right'>",
	                    ...
	                    "<input id='", ZLoginFactory.REMEMBER_ME_ID, "' value='1' type='checkbox' name='", ZLoginFactory.REMEMBER_ME_ID, "' />",
	                    "<label for='", ZLoginFactory.REMEMBER_ME_ID, "'>", params.rememberMeMsg, "</label>",
	                "</td>",
                "</tr>",	
    			"</table>",
    			"</form>",
