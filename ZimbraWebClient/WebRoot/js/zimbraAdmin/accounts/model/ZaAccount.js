...
function(tmpObj, app) {
	...
	**/
	...
	if(parseInt(tmpObj.attrs[ZaAccount.A_zimbraMaxPwdAge]) < parseInt(tmpObj.attrs[ZaAccount.A_zimbraMinPwdAge]) && parseInt(tmpObj.attrs[ZaAccount.A_zimbraMaxPwdAge]) > 0) {
		//show error msg
