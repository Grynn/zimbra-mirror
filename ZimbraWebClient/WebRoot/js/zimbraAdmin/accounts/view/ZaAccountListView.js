...
function(listType) {
	...
	if (this._listType && this._listType == ZaItem.ALIAS) {
		...
		headerList[i++] = new ZaListHeaderItem(ZaAccount.A_zimbraLastLogonTimestamp, ZaMsg.ALV_Last_Login, null, Dwt_Button_XFormItem.estimateMyWidth(ZaMsg.ALV_Last_Login, false, 0,100), sortable++, ZaAccount.A_zimbraLastLogonTimestamp, true, true);
	}
