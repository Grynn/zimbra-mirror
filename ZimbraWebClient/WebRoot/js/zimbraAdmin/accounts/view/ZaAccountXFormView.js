		...
		items: [
			...
			{type:_TAB_BAR_,  ref:ZaModel.currentTab,
				choices:[
					...
					{value:2, label:ZaMsg.TABT_ContactInfo},					
					{value:3, label:ZaMsg.TABT_Features},
					{value:4, label:ZaMsg.TABT_Preferences},					
			...
			{type:_SWITCH_, align:_LEFT_, valign:_TOP_, 
				items:[
					...
					{type:_CASE_, numCols:1, relevant:"instance[ZaModel.currentTab] == 3",
						items: [
							{ref:ZaAccount.A_zimbraFeatureContactsEnabled, type:_COS_CHECKBOX_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_FeatureContactsEnabled,label:ZaMsg.NAD_FeatureContactsEnabled+":", labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE", onChange:ZaTabView.onFormFieldChanged},							
							{ref:ZaAccount.A_zimbraFeatureCalendarEnabled, type:_COS_CHECKBOX_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_FeatureCalendarEnabled,label:ZaMsg.NAD_FeatureCalendarEnabled+":", labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE", onChange:ZaTabView.onFormFieldChanged},														
							{ref:ZaAccount.A_zimbraFeatureTaggingEnabled, type:_COS_CHECKBOX_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_FeatureTaggingEnabled,label:ZaMsg.NAD_FeatureTaggingEnabled+":", labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE", onChange:ZaTabView.onFormFieldChanged},
							{ref:ZaAccount.A_zimbraFeatureAdvancedSearchEnabled, type:_COS_CHECKBOX_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_FeatureAdvancedSearchEnabled,label:ZaMsg.NAD_FeatureAdvancedSearchEnabled+":", labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE", onChange:ZaTabView.onFormFieldChanged},
							{ref:ZaAccount.A_zimbraFeatureSavedSearchesEnabled, type:_COS_CHECKBOX_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_FeatureSavedSearchesEnabled,label:ZaMsg.NAD_FeatureSavedSearchesEnabled+":", labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE", onChange:ZaTabView.onFormFieldChanged},
							{ref:ZaAccount.A_zimbraFeatureConversationsEnabled, type:_COS_CHECKBOX_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_FeatureConversationsEnabled,label:ZaMsg.NAD_FeatureConversationsEnabled+":", labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE", onChange:ZaTabView.onFormFieldChanged},
							{ref:ZaAccount.A_zimbraFeatureChangePasswordEnabled, type:_COS_CHECKBOX_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_FeatureChangePasswordEnabled,label:ZaMsg.NAD_FeatureChangePasswordEnabled+":", labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE"},
							{ref:ZaAccount.A_zimbraFeatureInitialSearchPreferenceEnabled, type:_COS_CHECKBOX_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_FeatureInitialSearchPreferenceEnabled,label:ZaMsg.NAD_FeatureInitialSearchPreferenceEnabled+":", labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE", onChange:ZaTabView.onFormFieldChanged},
							{ref:ZaAccount.A_zimbraFeatureFiltersEnabled, type:_COS_CHECKBOX_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_FeatureFiltersEnabled,label:ZaMsg.NAD_FeatureFiltersEnabled+":", labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE", onChange:ZaTabView.onFormFieldChanged},
							{ref:ZaAccount.A_zimbraFeatureHtmlComposeEnabled, type:_COS_CHECKBOX_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_zimbraFeatureHtmlComposeEnabled,label:ZaMsg.NAD_zimbraFeatureHtmlComposeEnabled+":", labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE", onChange:ZaTabView.onFormFieldChanged},							
							{ref:ZaAccount.A_zimbraFeatureGalEnabled, type:_COS_CHECKBOX_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_FeatureGalEnabled,label:ZaMsg.NAD_FeatureGalEnabled+":", labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE", onChange:ZaTabView.onFormFieldChanged},
							{ref:ZaAccount.A_zimbraImapEnabled, type:_COS_CHECKBOX_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_zimbraImapEnabled,label:ZaMsg.NAD_zimbraImapEnabled+":", labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE", onChange:ZaTabView.onFormFieldChanged},
							{ref:ZaAccount.A_zimbraPop3Enabled, type:_COS_CHECKBOX_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_zimbraPop3Enabled,label:ZaMsg.NAD_zimbraPop3Enabled+":", labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE", onChange:ZaTabView.onFormFieldChanged}								
						]
					},
					{type:_CASE_, numCols:1,relevant:"instance[ZaModel.currentTab] == 4",
						items :[
							{ref:ZaAccount.A_prefSaveToSent, type:_COS_CHECKBOX_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_prefSaveToSent,label:ZaMsg.NAD_prefSaveToSent+":", labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE",onChange:ZaTabView.onFormFieldChanged},
							{ref:ZaAccount.A_zimbraPrefMessageViewHtmlPreferred, type:_COS_CHECKBOX_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_zimbraPrefMessageViewHtmlPreferred,label:ZaMsg.NAD_zimbraPrefMessageViewHtmlPreferred+":", labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE",onChange:ZaTabView.onFormFieldChanged},
							{ref:ZaAccount.A_zimbraPrefComposeInNewWindow, type:_COS_CHECKBOX_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_zimbraPrefComposeInNewWindow,label:ZaMsg.NAD_zimbraPrefComposeInNewWindow+":", labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE",onChange:ZaTabView.onFormFieldChanged},							
							{ref:ZaAccount.A_zimbraPrefForwardReplyInOriginalFormat, type:_COS_CHECKBOX_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_zimbraPrefForwardReplyInOriginalFormat,label:ZaMsg.NAD_zimbraPrefForwardReplyInOriginalFormat+":", labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE",onChange:ZaTabView.onFormFieldChanged},														
							{ref:ZaAccount.A_zimbraPrefComposeFormat, type:_COS_SELECT1_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_zimbraPrefComposeFormat,label:ZaMsg.NAD_zimbraPrefComposeFormat+":", labelLocation:_LEFT_, onChange:ZaTabView.onFormFieldChanged},							
							{ref:ZaAccount.A_zimbraPrefAutoAddAddressEnabled, type:_COS_CHECKBOX_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_zimbraPrefAutoAddAddressEnabled,label:ZaMsg.NAD_zimbraPrefAutoAddAddressEnabled+":", labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE",onChange:ZaTabView.onFormFieldChanged},							
							{type:_SEPARATOR_},
							{ref:ZaAccount.A_zimbraPrefGroupMailBy, type:_COS_SELECT1_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_zimbraPrefGroupMailBy,label:ZaMsg.NAD_zimbraPrefGroupMailBy+":", labelLocation:_LEFT_, onChange:ZaTabView.onFormFieldChanged},							
							{ref:ZaAccount.A_zimbraPrefContactsPerPage, type:_COS_SELECT1_, msgName:ZaMsg.NAD_PrefContactsPerPage,label:ZaMsg.NAD_PrefContactsPerPage+":", labelLocation:_LEFT_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, valueLabel:null,onChange:ZaTabView.onFormFieldChanged},							
							{ref:ZaAccount.A_zimbraPrefMailItemsPerPage, type:_COS_SELECT1_, msgName:ZaMsg.NAD_zimbraPrefMailItemsPerPage,label:ZaMsg.NAD_zimbraPrefMailItemsPerPage+":", labelLocation:_LEFT_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, valueLabel:null,onChange:ZaTabView.onFormFieldChanged},
							{ref:ZaAccount.A_zimbraPrefMailInitialSearch, type:_COS_TEXTFIELD_, msgName:ZaMsg.NAD_zimbraPrefMailInitialSearch,label:ZaMsg.NAD_zimbraPrefMailInitialSearch+":", labelLocation:_LEFT_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, cssClass:"admin_xform_name_input", valueLabel:null,onChange:ZaTabView.onFormFieldChanged},
							{ref:ZaAccount.A_zimbraPrefShowSearchString, type:_COS_CHECKBOX_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_zimbraPrefShowSearchString,label:ZaMsg.NAD_zimbraPrefShowSearchString+":", labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE",onChange:ZaTabView.onFormFieldChanged},
							{ref:ZaAccount.A_zimbraPrefUseTimeZoneListInCalendar, type:_COS_CHECKBOX_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_zimbraPrefUseTimeZoneListInCalendar,label:ZaMsg.NAD_zimbraPrefUseTimeZoneListInCalendar+":", labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE",onChange:ZaTabView.onFormFieldChanged},							
							{ref:ZaAccount.A_zimbraPrefImapSearchFoldersEnabled, type:_COS_CHECKBOX_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_zimbraPrefImapSearchFoldersEnabled,label:ZaMsg.NAD_zimbraPrefImapSearchFoldersEnabled+":", labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE",onChange:ZaTabView.onFormFieldChanged},														
							{type:_SEPARATOR_},							
							...
							{ref:ZaAccount.A_zimbraPrefMailSignatureStyle, type:_COS_SELECT1_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_zimbraPrefMailSignatureStyle,label:ZaMsg.NAD_zimbraPrefMailSignatureStyle+":", labelLocation:_LEFT_, onChange:ZaTabView.onFormFieldChanged},
					...
					{type:_CASE_, numCols:1, relevant:"instance[ZaModel.currentTab] ==7",
						items: [
							{type:_GROUP_, numCols:2,
								items :[
									{ref:ZaAccount.A_zimbraAttachmentsBlocked, type:_COS_CHECKBOX_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_RemoveAllAttachments,label:ZaMsg.NAD_RemoveAllAttachments+":", labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE", onChange:ZaTabView.onFormFieldChanged},
									{ref:ZaAccount.A_zimbraAttachmentsViewInHtmlOnly, type:_COS_CHECKBOX_, 
										checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_AttachmentsViewInHtmlOnly,label:ZaMsg.NAD_AttachmentsViewInHtmlOnly+":", labelLocation:_LEFT_, 
									...
									{ref:ZaAccount.A_zimbraAttachmentsIndexingEnabled, type:_COS_CHECKBOX_, 
										checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_zimbraAttachmentsIndexingEnabled,label:ZaMsg.NAD_zimbraAttachmentsIndexingEnabled+":", labelLocation:_LEFT_, 
										trueValue:"TRUE", falseValue:"FALSE", onChange:ZaTabView.onFormFieldChanged,									
										relevant:"instance.globalConfig.attrs[ZaGlobalConfig.A_zimbraComponentAvailable_convertd]",
										relevantBehavior:_HIDE_
									}
							...
							{type:_GROUP_, numCols:2, 
								items: [
									{ref:ZaAccount.A_zimbraMailQuota, type:_COS_TEXTFIELD_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_MailQuota,label:ZaMsg.NAD_MailQuota+":", msgName:ZaMsg.NAD_MailQuota,labelLocation:_LEFT_, cssClass:"admin_xform_number_input", onChange:ZaTabView.onFormFieldChanged, checkBoxLabel:ZaMsg.NAD_OverrideCOS},
									{ref:ZaAccount.A_zimbraContactMaxNumEntries, type:_COS_TEXTFIELD_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_ContactMaxNumEntries,label:ZaMsg.NAD_ContactMaxNumEntries+":", labelLocation:_LEFT_, cssClass:"admin_xform_number_input", onChange:ZaTabView.onFormFieldChanged}
								]
							},
							{type:_SEPARATOR_},
							{type:_GROUP_, numCols:2, 
								items: [
									{ref:ZaAccount.A_zimbraMinPwdLength, type:_COS_TEXTFIELD_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_passMinLength,label:ZaMsg.NAD_passMinLength+":", labelLocation:_LEFT_, cssClass:"admin_xform_number_input", onChange:ZaTabView.onFormFieldChanged},
									{ref:ZaAccount.A_zimbraMaxPwdLength, type:_COS_TEXTFIELD_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_passMaxLength,label:ZaMsg.NAD_passMaxLength+":", labelLocation:_LEFT_, cssClass:"admin_xform_number_input", onChange:ZaTabView.onFormFieldChanged},
									{ref:ZaAccount.A_zimbraMinPwdAge, type:_COS_TEXTFIELD_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_passMinAge,label:ZaMsg.NAD_passMinAge+":", labelLocation:_LEFT_, cssClass:"admin_xform_number_input", onChange:ZaTabView.onFormFieldChanged},
									{ref:ZaAccount.A_zimbraMaxPwdAge, type:_COS_TEXTFIELD_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_passMaxAge,label:ZaMsg.NAD_passMaxAge+":", labelLocation:_LEFT_, cssClass:"admin_xform_number_input", onChange:ZaTabView.onFormFieldChanged},
									{ref:ZaAccount.A_zimbraEnforcePwdHistory, type:_COS_TEXTFIELD_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_passEnforceHistory,label:ZaMsg.NAD_passEnforceHistory+":", labelLocation:_LEFT_, cssClass:"admin_xform_number_input", onChange:ZaTabView.onFormFieldChanged},
									{ref:ZaAccount.A_zimbraPasswordLocked, type:_COS_CHECKBOX_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_PwdLocked,label:ZaMsg.NAD_PwdLocked+":", labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE", onChange:ZaTabView.onFormFieldChanged}
								]
							},
							{type:_SEPARATOR_},							
							{type:_GROUP_, numCols:2, 
								items: [
									{ref:ZaAccount.A_zimbraAuthTokenLifetime, type:_COS_LIFETIME_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_AuthTokenLifetime,label:ZaMsg.NAD_AuthTokenLifetime+":",labelLocation:_LEFT_, onChange:ZaTabView.onFormFieldChanged},								
									{ref:ZaAccount.A_zimbraMailMessageLifetime, type:_COS_LIFETIME1_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_MailMessageLifetime,label:ZaMsg.NAD_MailMessageLifetime+":",labelLocation:_LEFT_, onChange:ZaTabView.onFormFieldChanged},
									{ref:ZaAccount.A_zimbraMailTrashLifetime, type:_COS_LIFETIME1_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_MailTrashLifetime,label:ZaMsg.NAD_MailTrashLifetime+":", labelLocation:_LEFT_, onChange:ZaTabView.onFormFieldChanged},
									{ref:ZaAccount.A_zimbraMailSpamLifetime, type:_COS_LIFETIME1_, checkBoxLabel:ZaMsg.NAD_OverrideCOS, msgName:ZaMsg.NAD_MailSpamLifetime,label:ZaMsg.NAD_MailSpamLifetime+":", labelLocation:_LEFT_, onChange:ZaTabView.onFormFieldChanged}
								]
							},
							{type:_SEPARATOR_},
							{type:_GROUP_, numCols:2, 
