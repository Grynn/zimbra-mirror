	...
	if(ZaSettings.ACCOUNTS_PREFS_ENABLED) {
		cases.push({type:_CASE_, width:"100%", relevant:("instance[ZaModel.currentTab] == " + _tab5),
					...
					items :[
						...
						{type:_SEPARATOR_},
						{ref:ZaAccount.A_zimbraPrefGroupMailBy, type:_SUPER_SELECT1_, resetToSuperLabel:ZaMsg.NAD_ResetToCOS, msgName:ZaMsg.NAD_zimbraPrefGroupMailBy,label:ZaMsg.NAD_zimbraPrefGroupMailBy, labelLocation:_LEFT_,forceUpdate:true, onChange:ZaTabView.onFormFieldChanged},							
