...
ZaAccountXFormView.myXFormModifier = function(xFormObject, entry) {	
    ...
    //assigned quota
    headerItems.push ({type:_OUTPUT_,ref:ZaAccount.A2_quota, label:ZaMsg.LBL_assignedQuota,
                        getDisplayValue:function() {
							var val = this.getInstanceValue();
                            return val + " MB" ;
						}
		...
		var prefItems = [
						...
						{type:_ZA_PLAIN_GROUPER_, id:"account_prefs_mail_general",colSizes:["175px","auto"],numCols:2,
							items :[
								...
								{ref:ZaAccount.A_zimbraPrefMailItemsPerPage, 
									type:_SUPER_SELECT1_, 
									labelCssStyle:"width:175px", colSizes:["375px","190px"],
									msgName:ZaMsg.LBL_zimbraPrefMailItemsPerPage,
						...
						{type:_ZA_PLAIN_GROUPER_, id:"account_prefs_calendar_general",colSizes:["175px","565px"],
							...
							items :[
								...
								{ref:ZaAccount.A_zimbraPrefAppleIcalDelegationEnabled, type:_SUPER_CHECKBOX_,
								...
								colSizes:["175px","375px","190px"], resetToSuperLabel:ZaMsg.NAD_ResetToCOS, msgName:ZaMsg.LBL_zimbraPrefCalendarNotifyDelegatedChanges,checkBoxLabel:ZaMsg.LBL_zimbraPrefCalendarNotifyDelegatedChanges, trueValue:"TRUE", falseValue:"FALSE"},
								{ref:ZaAccount.A_zimbraPrefCalendarAlwaysShowMiniCal, type:_SUPER_CHECKBOX_,
								colSizes:["175px","375px","190px"], resetToSuperLabel:ZaMsg.NAD_ResetToCOS, msgName:ZaMsg.LBL_zimbraPrefCalendarAlwaysShowMiniCal,checkBoxLabel:ZaMsg.LBL_zimbraPrefCalendarAlwaysShowMiniCal, trueValue:"TRUE", falseValue:"FALSE"},
								{ref:ZaAccount.A_zimbraPrefCalendarUseQuickAdd, 
								colSizes:["175px","375px","190px"], type:_SUPER_CHECKBOX_, resetToSuperLabel:ZaMsg.NAD_ResetToCOS, msgName:ZaMsg.LBL_zimbraPrefCalendarUseQuickAdd,checkBoxLabel:ZaMsg.LBL_zimbraPrefCalendarUseQuickAdd, trueValue:"TRUE", falseValue:"FALSE"},
								{ref:ZaAccount.A_zimbraPrefUseTimeZoneListInCalendar, 
								colSizes:["175px","375px","190px"], type:_SUPER_CHECKBOX_, resetToSuperLabel:ZaMsg.NAD_ResetToCOS, msgName:ZaMsg.LBL_zimbraPrefUseTimeZoneListInCalendar,checkBoxLabel:ZaMsg.LBL_zimbraPrefUseTimeZoneListInCalendar,trueValue:"TRUE", falseValue:"FALSE"}
							]
						}						
					];
