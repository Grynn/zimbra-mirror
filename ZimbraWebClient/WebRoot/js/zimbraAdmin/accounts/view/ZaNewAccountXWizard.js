	...
	if(ZaSettings.ACCOUNTS_PREFS_ENABLED) {
		cases.push({type:_CASE_, relevant:"instance[ZaModel.currentStep] == 6", 
					items :[
						...
						{ref:ZaAccount.A_zimbraPrefMailLocalDeliveryDisabled,labelCssStyle:"width:190px;", type:_SUPER_CHECKBOX_,resetToSuperLabel:ZaMsg.NAD_ResetToCOS, msgName:ZaMsg.NAD_zimbraPrefMailLocalDeliveryDisabled,label:ZaMsg.NAD_zimbraPrefMailLocalDeliveryDisabled, labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE",labelCssClass:"xform_label", align:_LEFT_},						
						{type:_SEPARATOR_},							
