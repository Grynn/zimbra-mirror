...
ZaNewAccountXWizard.myXFormModifier = function(xFormObject) {	
	...
	if(ZaSettings.ACCOUNTS_FORWARDING_ENABLED) {
		cases.push({type:_CASE_, numCols:1, relevant:"instance[ZaModel.currentStep] == 4",
					items: [
		...
		cases.push({type:_CASE_, relevant:"instance[ZaModel.currentStep] == 6", 
					items :[
						...
						{ref:ZaAccount.A_zimbraPrefContactsPerPage,
							labelCssStyle:"width:150px;", type:_SUPER_TEXTFIELD_, 
						...
						{ref:ZaAccount.A_zimbraPrefUseTimeZoneListInCalendar,labelCssStyle:"width:150px;", type:_SUPER_CHECKBOX_, resetToSuperLabel:ZaMsg.NAD_ResetToCOS, msgName:ZaMsg.NAD_zimbraPrefUseTimeZoneListInCalendar,label:ZaMsg.NAD_zimbraPrefUseTimeZoneListInCalendar, labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE"},							
						{ref:ZaAccount.A_zimbraPrefImapSearchFoldersEnabled, labelCssStyle:"width:150px;", type:_SUPER_CHECKBOX_, resetToSuperLabel:ZaMsg.NAD_ResetToCOS, msgName:ZaMsg.NAD_zimbraPrefImapSearchFoldersEnabled,label:ZaMsg.NAD_zimbraPrefImapSearchFoldersEnabled, labelLocation:_LEFT_, trueValue:"TRUE", falseValue:"FALSE"},														
						{type:_SEPARATOR_},							
