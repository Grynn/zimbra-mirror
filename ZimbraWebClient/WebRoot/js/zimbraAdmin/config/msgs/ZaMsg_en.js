...
ZaMsg.Restore_SelectZabel = "Please select the backup label to restore from.";
ZaMsg.Restore_Zabel = "Backup label to restore from:";
ZaMsg.Restore_Restore = "Restore";
ZaMsg.Restore_NoZabelsFound = "Could not find any backup labels in the specified target";
ZaMsg.Restore_ZabelsProblem = "Server encountered a problem when looking for backup labels";
ZaMsg.Restore_IncludeIncrementals = "Include incremental backups";
ZaMsg.Restore_LookingForZabels = "Looking for labels";
...
ZaMsg.NAD_StatsDataZastDay = "24 hour window";
ZaMsg.NAD_StatsDataZast3Months = "3 months window";
ZaMsg.NAD_StatsDataZast12Months = "12 months window";
ZaMsg.NAD_DefaultDomainName = "Default domain:";

ZaMsg.TABT_StatsDataZastDay = "24 Hours";
ZaMsg.TABT_StatsDataZast3Months = "3 Months";
ZaMsg.TABT_StatsDataZast12Months = "12 Months";

//ZaMsg.NAD_StatsMsgsZastDay = "Messages in last day";
//ZaMsg.NAD_StatsMsgsZast3Months = "Messages in last 3 months";
//ZaMsg.NAD_StatsMsgsZast12Months = "Messages in last 12 months";
ZaMsg.NAD_StatsMsgsZastDay = "24 hour window";
ZaMsg.NAD_StatsMsgsZast3Months = "3 months window";
ZaMsg.NAD_StatsMsgsZast12Months = "12 months window";
ZaMsg.NAD_ZastLogonTimestampFrequency = "Zast Logon Timestamp Frequency";
...
ZaMsg.ATTR = new Object();
	...
	ZaMsg.ATTR[ZaAccount.A_lastName] =  "Zast Name",
...
ZaMsg.done = "Done";
ZaMsg.searchForAccounts = "Search for accounts";
ZaMsg.search = "Search For Accounts";
ZaMsg.queryParseError = "Unable to parse your search query. Please correct any errors and resubmit.";
ZaMsg.zimbraAdminTitle = "Zimbra Mail Administration";
ZaMsg.usedQuota = "Used quota";
ZaMsg.login = " Log On ";
ZaMsg.loginHeader = "Zimbra Mail Administration Console";
