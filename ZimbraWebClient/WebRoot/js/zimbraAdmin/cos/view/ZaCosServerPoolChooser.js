...
ZaCosServerPoolChooser.prototype = new DwtChooser;
ZaCosServerPoolChooser.prototype.constructor = ZaCosServerPoolChooser;

ZaCosServerPoolChooser.prototype._createHtml = 
function() {
	...
	html[idx++] = "<tbody>";
	html[idx++] = "<tr><td style='text-align:center' class='xform_label'>" + ZaMsg.ServerPool_AllServers + "</td><td>&nbsp;</td><td style='text-align:center'  class='xform_label'>" + ZaMsg.ServerPool_ServersInPool + "</td</tr>"
	html[idx++] = "<tr>";
