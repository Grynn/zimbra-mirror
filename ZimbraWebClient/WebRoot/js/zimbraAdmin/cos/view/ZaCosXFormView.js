				...
				items:[
					...
					{type:_CASE_,relevant:"instance[ZaModel.currentTab] == 3",
						items :[
							...
							{ref:ZaCos.A_zimbraPrefMailSignatureStyle, type:_OSELECT1_, msgName:ZaMsg.NAD_zimbraPrefMailSignatureStyle,label:ZaMsg.NAD_zimbraPrefMailSignatureStyle+":", labelLocation:_LEFT_, onChange:ZaTabView.onFormFieldChanged},							
