		...
		items:[
			{type:_SWITCH_, items:[
				...
				{type:_CASE_, relevant:"instance.gt==ZaDomain.A_NotebookDomainACLs",
					items:[
						{ref:".", type:_ACL_, label:ZaMsg.ACL_Dom,labelLocation:_LEFT_}						
					]
				},
				{type:_CASE_, relevant:"instance.gt==ZaDomain.A_NotebookAllACLs",
					items:[
						{ref:".", type:_ACL_, label:ZaMsg.ACL_All,labelLocation:_LEFT_}						
					]
				},								
				{type:_CASE_, relevant:"instance.gt==ZaDomain.A_NotebookPublicACLs",
					items:[
						{ref:".", type:_ACL_, visibleBoxes:{r:true,w:false,a:false,i:false,d:false,x:false},
