...
ZaAccountXFormView.myXFormModifier = function(xFormObject) {	
	...
	if(ZaSettings.COSES_ENABLED) {
        ...
        headerItems.push({type:_OUTPUT_, ref:ZaAccount.A_COSId, labelLocation:_LEFT_, label:com_zimbra_yahoosmb.AccountTypeLabel,
                choices: SMBAccount.getAccountTypeChoicesByCosId(this._app.getCosList())
           });
    }
	...
	var setupGroup = {type:_TOP_GROUPER_, label:ZaMsg.NAD_AccountSetupGrouper, id:"account_form_setup_group", 
		...
		items: [
            ...
            {ref:ZaAccount.A_accountStatus, type:_OSELECT1_, msgName:ZaMsg.NAD_AccountStatus,
                relevant: "(instance.attrs[ZaAccount.A_zimbraYahooId] != null) && (instance.attrs[ZaAccount.A_zimbraYahooId].length > 0)",
                relevantBehavior: _DISABLE_,
            ...
            {ref:ZaAccount.A_zimbraYahooId,  type: _TEXTFIELD_,
                    label: com_zimbra_yahoosmb.L_zimbraYahooId, labelLocation: _LEFT_,
	...
	if(ZaSettings.ACCOUNTS_FEATURES_ENABLED) {
		cases.push({type:_ZATABCASE_,id:"account_form_features_tab",  numCols:1, width:"100%", relevant:("instance[ZaModel.currentTab] == " + _tab4),
				items: [
                    ...
                    {type:_ZA_TOP_GROUPER_, label: ZaMsg.NAD_zimbraGeneralFeature, id:"account_form_features_major", colSizes:["auto"],numCols:1,
						items:[
                            ...
                            {ref:ZaAccount.A_zimbraFeatureImapDataSourceEnabled, type:_SUPER_CHECKBOX_, resetToSuperLabel:ZaMsg.NAD_ResetToCOS, msgName:ZaMsg.NAD_zimbraExternalImapEnabled,checkBoxLabel:ZaMsg.NAD_zimbraExternalImapEnabled,  trueValue:"TRUE", falseValue:"FALSE", onChange:ZaTabView.onFormFieldChanged},    
							...
							items: [
                                { type: _DWT_ALERT_,
                                  ...
                                  content: ZaMsg.Alert_EnableMailRetention
                                    /// always display it in the PA admin,
