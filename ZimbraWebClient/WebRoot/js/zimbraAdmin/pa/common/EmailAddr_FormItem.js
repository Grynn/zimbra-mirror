...
function () {
	...
	try {
        /** For PA domain admin, it is always ZaSettings.myDomainName */
...
EmailAddr_XFormItem.prototype.items = [
	...
	{type:_OUTPUT_, value:"@"},
	{type:_OUTPUT_,ref:".",relevant:"(!ZaSettings.DOMAINS_ENABLED) || (ZaSettings.isYahooSmbDomainAdmin)", relevantBehavior:_HIDE_,
...
//				if(this.getChoices() && this.getChoices()._choiceObject && this.getChoices()._choiceObject[0])
	...
	{type:_DYNSELECT_DOMAIN_PART_, ref:".", labelLocation:_NONE_, relevantBehavior:_HIDE_, 
	 	...
	 	relevant:"ZaSettings.DOMAINS_ENABLED && (!ZaSettings.isYahooSmbDomainAdmin)",dataFetcherMethod:ZaSearch.prototype.dynSelectSearchDomains,
