	...
	xFormObject.items = [
		...
		{type:_SWITCH_, items:[
				...
				items:[
                        ...
                        {ref:ZaAccount.A_zimbraMailCatchAllAddress, type:_OSELECT1_,
							label:com_zimbra_yahoosmb.L_catchAll, labelLocation:_LEFT_,
							choices:SMBAccount.getCatchAllChoices(ZaSettings.myDomainName),
