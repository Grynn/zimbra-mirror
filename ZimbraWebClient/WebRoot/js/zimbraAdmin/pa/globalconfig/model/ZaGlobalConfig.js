...
function(by, val, withConfig) {
	if(!ZaSettings.GLOBAL_CONFIG_ENABLED)
		return;
	var soapDoc = AjxSoapDoc.create("GetAllSmbConfigRequest", ZaZimbraAdmin.URN, null);
	...
	var resp = ZaRequestMgr.invoke(params, reqMgrParams).Body.GetAllSmbConfigResponse;
