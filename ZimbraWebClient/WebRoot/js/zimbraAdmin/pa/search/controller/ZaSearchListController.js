...
function () {
    ...
    this._popupOperations.push(new ZaOperation(ZaOperation.SEND_PA_ACCOUNT_NOTIFICATION, com_zimbra_yahoosmb.Bt_send_notification, com_zimbra_yahoosmb.Bt_send_notification_tt, "Properties", "PropertiesDis", new AjxListener(this, ZaAccountListController.prototype._sendNotificationButtonListener)))
...
function () {
    ...
    this._toolbarOperations.push(new ZaOperation(ZaOperation.SEND_PA_ACCOUNT_NOTIFICATION, com_zimbra_yahoosmb.Bt_send_notification,
                        com_zimbra_yahoosmb.Bt_send_notification_tt, "Properties", "PropertiesDis",
                        new AjxListener(this, ZaAccountListController.prototype._sendNotificationButtonListener)));
	...
	if(cnt == 1) {
		...
		if (item) {
			...
			if (item.type == ZaItem.ALIAS) {
		        ...
		        opsArray2.push(ZaOperation.SEND_PA_ACCOUNT_NOTIFICATION);
                ...
                if (item.attrs[ZaAccount.A_accountStatus] == SMBAccount.SUSPENDED_STATUS)
                    opsArray1.push(ZaOperation.SEND_PA_ACCOUNT_NOTIFICATION);
                else
                    opsArray2.push(ZaOperation.SEND_PA_ACCOUNT_NOTIFICATION);
