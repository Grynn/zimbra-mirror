...
function (optionId){
    ...
    }else if (optionId == ZaSearchOption.BASIC_FILTER_ID) {
...
function (optionId, height){
    ...
    var extMailFilterItem = [
        {type:_OUTPUT_, value: ZaMsg.LB_External_mail},
        {type:_TEXTFIELD_, ref: ZaSearchOption.A_zimbraMailForwardingAddress, enableDisableChecks:[],
