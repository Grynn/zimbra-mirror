...
ZaServer.myXModel = {
	items: [
		...
		{id:ZaServer.A_ServiceHostname, ref:"attrs/" +  ZaServer.A_ServiceHostname, type:_STRING_/*, pattern: AjxUtil.DOMAIN_NAME_SHORT_RE*/},
		// Services
		...
		{id:ZaServer.A_zimbraMtaRelayHost, ref:"attrs/" +  ZaServer.A_zimbraMtaRelayHost, type: _STRING_/*, pattern: [AjxUtil.HOST_NAME_RE,AjxUtil.IP_ADDRESS_RE]*/ },
		...
		// ...other...
		{id:ZaServer.A_SmtpHostname, ref:"attrs/" +  ZaServer.A_SmtpHostname, type:_STRING_/*, pattern: [AjxUtil.HOST_NAME_RE,AjxUtil.IP_ADDRESS_RE]*/ },
		...
		{id:ZaServer.A_LmtpBindAddress, ref:"attrs/" +  ZaServer.A_LmtpBindAddress, type:_STRING_/*, pattern: [AjxUtil.HOST_NAME_RE,AjxUtil.IP_ADDRESS_RE]*/ },
		...
		{id:ZaServer.A_Pop3NumThreads, ref:"attrs/" +  ZaServer.A_Pop3NumThreads, type:_STRING_},		
		{id:ZaServer.A_Pop3AdvertisedName, ref:"attrs/" +  ZaServer.A_Pop3AdvertisedName, type:_STRING_},		
		{id:ZaServer.A_Pop3BindAddress, ref:"attrs/" +  ZaServer.A_Pop3BindAddress, type:_STRING_/*, pattern: [AjxUtil.HOST_NAME_RE,AjxUtil.IP_ADDRESS_RE]*/ },
