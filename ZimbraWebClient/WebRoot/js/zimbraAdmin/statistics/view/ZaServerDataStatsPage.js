/**
* @class ZaServerDataStatsPage 
* @contructor ZaServerDataStatsPage
* @param parent
* @param app
* @author Greg Solovyev
**/
function ZaServerDataStatsPage (parent, app) {
...
ZaServerDataStatsPage.prototype = new DwtTabViewPage;
ZaServerDataStatsPage.prototype.constructor = ZaServerDataStatsPage;

ZaServerDataStatsPage.prototype.toString = 
function() {
	return "ZaServerDataStatsPage";
}

ZaServerDataStatsPage.prototype.setObject =
function (item) {
	if(item) {
...
ZaServerDataStatsPage.prototype._createHTML = 
function () {
	var idx = 0;
