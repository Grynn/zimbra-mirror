function SideStepCarFindView(parent, appCtxt,zimlet, workAirportOptions, homeAirportOptions, workZip, homeZip) {
...
SideStepCarFindView.prototype = new DwtTabViewPage;
SideStepCarFindView.prototype.constructor = SideStepCarFindView;


// Public methods

SideStepCarFindView.prototype.toString = 
function() {
	return "SideStepCarFindView";
};

SideStepCarFindView.prototype.showMe = 
function () {
	if(!this._rendered)
		this._initialize();
...
SideStepCarFindView.prototype.setWorkAirports = 
function (workAirportOptions) {
	this.workAirportOptions = workAirportOptions
}

SideStepCarFindView.prototype.setPickupAirport = 
function (code) {
	this._pickupAirportField.setValue(code);
}

SideStepCarFindView.prototype.setDropoffAirport = 
function (code) {
	this._dropoffAirportField.setValue(code);
}

SideStepCarFindView.prototype.setDropoffDate =
...
SideStepCarFindView.prototype.setPickupDate =
function (pickupDate) {
...
SideStepCarFindView.prototype.resize =
...
SideStepCarFindView.prototype._initialize = 
function() {
...
SideStepCarFindView.prototype._createHTML = 
function() {
	var html = new Array();
	var i = 0;
...
SideStepCarFindView.prototype._createDwtObjects = 
function () {
...
SideStepCarFindView.prototype._cacheFields = 
function() {
...
SideStepCarFindView.prototype._dateButtonListener = function(ev) {
...
SideStepCarFindView.prototype._dateCalSelectionListener = function(ev) {
...
SideStepCarFindView.prototype._searchButtonListener = 
function (ev) {
...
SideStepCarFindView.prototype._mouseOverListener = 
function(ev) {
...
SideStepCarFindView.prototype._mouseOutListener = 
function(ev) {
	if(ev.target && ev.target.id) {
		if(ev.target.id==this._pick_coa_id) {
...
SideStepCarFindView.prototype._mouseDownListener = 
function(ev) {
	if(ev.target && ev.target.id) {
		if(ev.target.id==this._pick_coa_id) {
			/*alert("Clicked");*/
...
SideStepCarFindView.prototype._setPickupAirportCode = 
function (ev) {
...
SideStepCarFindView.prototype._setDropoffAirportCode = 
function (ev) {
	if(this._airportLookupDlg) {
		var code = this._airportLookupDlg.getSelectedAirport();
