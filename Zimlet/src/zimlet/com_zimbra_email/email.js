...
Com_Zimbra_Email.prototype._getRoster = function() {
...
Com_Zimbra_Email.prototype._rosterChangeListener = function(ev) {
				...
				content = AjxStringUtil.htmlEncode(contact.getFullName());
                                ...
                                if (pres) {
                                        ...
                                        var tmp = [
                                                content,
                                                " ",
                                                AjxImg.getImageHtml(pres.getIcon(),
                                        ...
                                        this._presenceCache.push({ contact : contact,
                                                                   buddy   : buddy,
...
Com_Zimbra_Email.prototype._newImListener = function() {
        var contact = this._getActionedContact(), buddy;
        if (contact)
...
Com_Zimbra_Email.prototype._getActionedContact = function(create) {
