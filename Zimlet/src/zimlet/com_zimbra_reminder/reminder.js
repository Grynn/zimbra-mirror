...
function() {
	...
	if(Com_Zimbra_Reminder._reminders.length < 1) {
		...
		var i = 0;
		var html = [];
		html[i++] = "<table id=\"reminderTable\" style=\"width: 300px;border: 1px solid grey; padding: 0.5em;\"><tr><td><img src=\"/zimbra/img/hiRes/common/CloseDis.gif\"/></td><td><b>";
		...
		for(var j=0;j<Com_Zimbra_Reminder._reminders.length;j++) {
			...
			html[i++] = ")\" src=\"/zimbra/img/hiRes/common/Close.gif\"/></td><td>";
