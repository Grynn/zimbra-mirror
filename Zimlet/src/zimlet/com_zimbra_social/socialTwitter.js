...
function com_zimbra_socialTwitter(zimlet) {
	this.zimlet = zimlet;
...
function(account) {
	var data = document.getElementById("social_statusTextArea").value;
...
com_zimbra_socialTwitter.prototype.addContentsToMail =
function(params, response) {
	var pId = "";
	var unReadCount = 0;
	var text = response.text;
