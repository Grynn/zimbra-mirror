...
function () {
	...
	this._departDateButton = ZmCalendarApp.createMiniCalButton(this, this._departDateMiniCalBtnId, dateButtonListener, dateCalSelectionListener, this._appCtxt, true);
	...
	this._returnDateButton = ZmCalendarApp.createMiniCalButton(this, this._returnDateMiniCalBtnId, dateButtonListener, dateCalSelectionListener, this._appCtxt, true);
